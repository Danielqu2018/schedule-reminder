...
**推荐方式**：使用项目中的 SQL 脚本文件

1. 在 Supabase Dashboard 中，点击左侧菜单的 **SQL Editor**
2. 点击 **New query**
3. 打开项目中的 `docs/sql/CREATE_SCHEDULES_TABLE.sql` 文件
4. 复制整个文件内容并粘贴到 SQL Editor
5. 点击 **Run** 执行 SQL
6. 确认执行成功（应显示 "Success" 或表创建成功的消息）

**或者手动执行**：如果您想手动创建，可以复制以下 SQL：
...
> 📖 **完整文档索引**：查看 [docs/INDEX.md](./docs/INDEX.md) 获取所有文档的详细导航和快速查找指南

### 快速链接

| 文档 | 说明 |
|------|------|
| **[文档索引](./docs/INDEX.md)** | 所有文档的完整索引和导航 ⭐ |
| **[数据库设置](./DATABASE_SETUP.md)** | 数据库配置详细指南 |
| **[团队设置指南](./docs/TEAM_SETUP_GUIDE.md)** | 团队功能配置指南 |
| **[故障排除](./docs/TROUBLESHOOTING.md)** | 常见问题解决方案 |
| **[SQL 脚本说明](./docs/sql/README.md)** | 所有 SQL 脚本的详细说明 |
